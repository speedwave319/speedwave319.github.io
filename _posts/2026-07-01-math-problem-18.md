...
(b) Define $\displaystyle f(x) = \frac{1}{x+ \sqrt{x^2 +a}}$ for all $x \geq 0$. Denote the graph of $y=f(x)$ by $G$. Let $R$ be the region bounded by $G$, the $x$-axis and the straight line $x=2$. Find the volume of the solid of revolution generated by revolving R about the x-axis.  
